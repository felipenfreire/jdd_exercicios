...
valor1 = int(input('Digite qualquer valor inteiro: '))
valor2 = int(input('Digite qualquer valor inteiro: '))
...
valor2 = int(input('Digite qualquer valor: '))
...
frase = input('Digite uma frase que você tem que lembrar dela todos os dias: ')
print(f'{frase.strip()}')

# 14. Faça um programa que peça ao usuário para digitar uma data no formato "dd/mm/aaaa" e, em seguida, imprima o dia, o mês e o ano separadamente.
data = input('Digite sua idade no formato "dd/mm/aaaa": ')
